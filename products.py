...
class ProductsDatabase:
    ...
    def _load_products(self) -> Dict[str, Product]:
        ...
        return {
            ...
            # Додані товари для тесту MVP
            "ashwagandha_test": Product(
                id="ashwagandha_test",
                name="Ашваганда",
                price_usd=1.3,
                category="adaptogens",
                emoji="🌱",
                description="Стрес, кортизол, тестостерон (тестовий товар)"
            ),
            "magnesium_test": Product(
                id="magnesium_test",
                name="Магній",
                price_usd=1.3,
                category="minerals",
                emoji="⚡",
                description="Сон, м’язи, нервова система (тестовий товар)"
            ),
            "retinol_ordinary": Product(
                id="retinol_ordinary",
                name="Сироватка з ретинолом Ordinary",
                price_usd=1.3,
                category="cosmetology",
                emoji="⏳",
                description="Зморшки, колаген, шкіра (тестовий товар)"
            )
            # Додай нові товари тут (для жіночого здоров’я, дієт, косметології, антифітнесу, фарми)
        }
